...
class PrepareData():
    ...
    def __init__(self):
        ...
        self.inputDirDigit = ["/Users/lanceren/Downloads/毕设实验数据/LPCR数据/训练字符识别模型数据/","/Users/lanceren/Downloads/毕设实验数据/tf_car_license_dataset/train_images/validation-set/"
        ...
        self.inputDirLetter = ["/Users/lanceren/Downloads/毕设实验数据/tf_car_license_dataset/train_images/training-set/letters/"]
        self.inputDirProvince = ["/Users/lanceren/Downloads/毕设实验数据/LPCR数据/训练字符识别模型数据/中文/","/Users/lanceren/Downloads/毕设实验数据/LPCR数据/car_charactes少/chinese/"]
    ...
    def SampleToValid(self):
        ...
        for i in range(0, self.trainTargetNumber):
            index = 0
            InputDir = self.saverDirTrain + f'{i}/'
            if os.path.exists(self.saverDirVal + f"{i}/") == False:
        ...
        for i in range(0, 24):
            ...
            if os.path.exists(self.saverDirVal + "letters/" + f"{i}/") == False:
        ...
        for i in range(0, 31):
            ...
            if os.path.exists(self.saverDirVal + "chinese-characters/" + f"{i}/") == False:
